...
interface IModalNewDepartmentProps {
  modal: UseModal;
  form: FormInstance<any>;
}

export default function ModalNewDepartment({ modal, form }: IModalNewDepartmentProps) {
    ...
    >
      ...
      >
        <Form.Item
          label="Nome"
          name="name"
          rules={[{ required: true, message: "Inserisci il nome del reparto." }]}
        >
          <Input />
        </Form.Item>
      </Form>
