...
interface IModalDeleteGlAccountProps {
  modal: UseModal;
  form: FormInstance<any>;
  loading: boolean
}

export default function RemoveGlAccountModal({
  modal,
  form,
  loading
}: IModalDeleteGlAccountProps) {
  ...
  return (
    ...
    >
      ...
      <Typography.Paragraph className="m-0">
        Sei sicuro di voler eliminare questo Gl-Account?
