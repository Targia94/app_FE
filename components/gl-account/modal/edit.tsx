...
interface IModalEditGlAccountProps {
  modal: UseModal
  form: FormInstance<any>
  loading: boolean
}

export default function ModalEditGlAccount({
  modal,
  form,
  loading,
}: IModalEditGlAccountProps) {
      ...
      >
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Inserisci la descrizione dell'elemento costante",
            },
          ]}
        >
          <Input maxLength={512} showCount />
